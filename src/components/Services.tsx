...
export const Services = () => {
  const digitalMarketingServices = [
    ...
    { icon: Building, title: "Google Business", description: "Optimize your Google Business profile for local visibility" },
    { icon: Search, title: "Google Maps", description: "Local SEO and Google Maps optimization" },
    { icon: Target, title: "Google Ads", description: "Strategic pay-per-click advertising campaigns" },
    ...
    { icon: Users, title: "Lead Management", description: "Systematic lead nurturing and conversion" },
    ...
    { icon: Globe, title: "Influencer Marketing", description: "Strategic partnerships with key influencers" }
  ];
