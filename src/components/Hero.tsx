...
import { ArrowRight, Play, Star, Users, Award, Store, Globe, Handshake } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative z-10">
                {/* Main Card */}
                <div className="bg-white/10 backdrop-blur-2g p-8 rounded-3xl border border-white/20 hover:bg-white/15 transition-all duration-500">
                  <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    <div className="bg-gradient-to-br from-[#FF6B35] to-orange-500 p-6 rounded-2xl text-white min-w-0">
                      <Globe className="w-8 h-8 mb-4" />
                      <div className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl break-words">Web Development</div>
                    </div>
                    <div className="bg-gradient-to-br from-blue-500 to-[#1E3D59] p-6 rounded-2xl text-white min-w-0">
                      <Handshake className="w-8 h-8 mb-4" />
                      <div className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl break-words">Joint ventures</div>
                    </div>
                    <div className="bg-gradient-to-br from-green-500 to-emerald-600 p-6 rounded-2xl text-white min-w-0">
                      <Store className="w-8 h-8 mb-4" />
                      <div className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl break-words">Franchise management</div>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500 to-pink-500 p-6 rounded-2xl text-white min-w-0">
                      <Users className="w-8 h-8 mb-4" />
                      <div className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl break-words">Manpower supply</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 -left-4 bg-pink-500 p-4 rounded-2xl animate-bounce delay-400">
                  <div className="text-2xl">💎</div>
                </div>
              </div>
            </div>
